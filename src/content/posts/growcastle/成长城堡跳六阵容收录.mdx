...
category: 成长城堡
draft: false
slug: growcastle/dh5-build-collection
---
...
|魅魔|CD: 11.01|<EquipDisplay w={['ATTACK SPEED +18.5%', 'CRITICAL CHANCE +10.0%', 'CRITICAL CHANCE +10.0%']} b={['ATTACK SPEED +9.6%', 'ATTACK SPEED +9.9%']} />|<EquipDisplay w={['ATTACK SPEED +18.0%', 'ATTACK SPEED +18.2%', 'CRITICAL CHANCE +9.0%']} y={['BONUS GOLD SKILL LV +1']} b={['ATTACK SPEED +9.6%', 'ATTACK SPEED +9.8%']} />|
...
**蓝边白袍 | 城弓 | 炸弹人 | 魅魔 | 黄毛 | 毒领**

***蓝边白袍？？？***

- 来源；[@syaaa7909](https://www.youtube.com/@syaaa7909)

- 视频链接：[YouTube](https://www.youtube.com/watch?v=E43FO7N4jOc)
...
{/* <iframe width="100%" height="468"
  src="https://www.youtube.com/embed/E43FO7N4jOc"
  title="SyaaaKr_"
  frameborder="0" allowfullscreen>
</iframe> */}
...
![SyaaaKr_ 阵容图](images/syaaakr__build.png)
