...
export const booknavConfig: BooknavGroup[] = [
	{
		...
		items: [
			...
			{
				title: "Flutter",
				url: "https://docs.flutter.cn",
				desc: "Flutter 文档中文版",
				weight: 9,
			},
			{
				title: "Kotlin",
				url: "https://book.kotlincn.net",
				desc: "Kotlin 官方文档中文版",
				weight: 8,
			},
			// {
	...
	},
	{
		...
		items: [
			{
				title: "GCC Next",
				url: "https://github.com/FnxAg/grow_castle_calculator_next",
				desc: "成长城堡计算器 Next",
				weight: 12,
			},
			{
				title: "Grow Castle Calculator",
				url: "https://github.com/FnxAg/GrowCastleCalculator",
				desc: "GCC Next 的前身",
				weight: 11,
			},
			// {
